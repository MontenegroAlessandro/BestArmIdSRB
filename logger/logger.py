...
class Logger:
    ...
    -If verbosity == 1 then also information are logged.
    ...
    def __init__(self, name_obj_logging, verbosity=3, mode='console', log_path=None, log_id=0):
        """
        Parameters
        ----------
        ...
        if self.log_path is not None:
            self.file_name = 'BAISRB_' + str(self.log_id) + datetime.datetime.now().strftime('_%Y%m%d__%H_%M_%S')
    ...
    def _to_console(self, msg, log_level):
        ...
        log_level: This is a string representing the log level which can be: 'INFO', 'WARNING', 'ERROR', 'DEBUG' or '
        EXCEPTION'.
    ...
    def _to_file(self, msg, log_level):
        ...
        Writes to file the log with the logging level and with the name of the object that has called the logging. If
        the file exists it is opened and the logging is appended to the end of the file. Else if the file does not exist
         it is created.
        """
        ...
        if self.log_path is not None:
            with open(self.log_path, 'a') as file:
                ...
                # i want to write to disk as soon as i call the _to_file() method. both of the following lines are
                # needed.
    ...
    def error(self, msg):
        ...
        Parameters
        ----------
        msg: This is a string, and it is the message that needs to be logged. It must be a message of error about
    ...
    def exception(self, msg):
        ...
        Parameters
        ----------
        msg: This is a string and it is the message that needs to be logged. It must be a message of exception about
        something exception that will be thrown just after the message is logged.
